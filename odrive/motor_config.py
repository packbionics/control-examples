"""
R80 KV110 Motor configurations for ODrive
...
class R80MotorConfig:
    ...
    def __init__(self, axis_num=0):
        """
        Initalizes R80MotorConfig class by finding odrive, erase its 
    ...
    def configure(self):
        ...
        self.odrv_axis.motor.config.pole_pairs = 21
        ...
        # stable.
        self.odrv_axis.motor.config.resistance_calib_max_voltage = 5
        self.odrv_axis.motor.config.requested_current_range      = 25
        self.odrv_axis.motor.config.current_control_bandwidth    = 300
        ...
        self.odrv_axis.motor.config.torque_constant = 8.27 / self.R80_KV
        ...
        self.odrv_axis.encoder.config.cpr = 126
        ...
        self.odrv_axis.encoder.config.bandwidth = 100 # TODO: not sure
        self.odrv_axis.controller.config.pos_gain = 20
...
if __name__ == "__main__":
    r80_motor_config = R80MotorConfig(axis_num = 0)
    r80_motor_config.configure()
    
    print("CONDUCTING MOTOR TEST")
    print("Placing motor in close loop control. If you move motor, motor will "
          "resist you.")
    r80_motor_config.mode_close_loop_control()
    ...
    for angle in range(0, 390, 30):
        ...
        r80_motor_config.move_input_pos(angle)
        time.sleep(5)
    
    print("Placing motor in idle. If you move motor, motor will "
          "move freely")
    r80_motor_config.mode_idle()
